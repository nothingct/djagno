...
#django 에서 기본적으로 제공하는 회원 관리 어플리케이션 
#에 있는 models.py 에 접근해 회원 클래스 임포트 
...
class SignupForm(ModelForm):
    #모델 클래스에 없는 입력양식 생성, 
    #forms에 들어있는 XXXXField 객체를 클래스 변수에 저장해서 구현
    #모델클래스 구현에 사용했던 클래스명과 유사하나 , 내부기능이 다르기 때문에 주의해야 함. 
    ...
    #forms에 들어있는 XXXXInput 객체를 widget 으로 지정하면 해당 타입으로 입력양식이 생성됨
